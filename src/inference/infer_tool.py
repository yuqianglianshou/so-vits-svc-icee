...
from src.path_utils import get_nsf_hifigan_model_path
from src.diffusion.unit2mel import load_model_vocoder
from src.inference import slicer
...
def read_temp(file_name):
    ...
    if not file_path.exists():
        ...
        try:
            ...
            print(e)
            print(f"{file_path.as_posix()} error,auto rebuild file")
