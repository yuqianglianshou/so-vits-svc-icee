...
from src.diffusion.data_loaders import get_data_loaders
from src.diffusion.logger import utils
from src.diffusion.solver import train
from src.diffusion.unit2mel import Unit2Mel
from src.diffusion.vocoder import Vocoder
from src.path_utils import get_diffusion_model_0_path
...
if __name__ == '__main__':
    ...
    initial_global_step, model, optimizer = utils.load_model(
        ...
        optimizer,
        device=args.device,
        fallback_checkpoint=str(get_diffusion_model_0_path()),
    )
