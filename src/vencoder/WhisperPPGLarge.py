...
from src.vencoder.whisper.audio import log_mel_spectrogram, pad_or_trim
from src.vencoder.whisper.model import ModelDimensions, Whisper


class WhisperPPGLarge(SpeechEncoder):
    def __init__(self, vec_path="model_assets/dependencies/large-v2.pt", device=None):
        super().__init__()
        if device is None:
