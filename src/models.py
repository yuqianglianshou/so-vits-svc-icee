...
from src.modules import attentions
from src.modules import commons
from src.modules import modules
from src import utils
from src.modules.commons import get_padding
from src.utils import f0_to_coarse
...
class SynthesizerTrn(nn.Module):
    ...
    def __init__(self,
        ...
        if vocoder_name == "nsf-hifigan":
            from src.vdecoder.hifigan.models import Generator
            self.dec = Generator(h=hps)
        elif vocoder_name == "nsf-snake-hifigan":
            from src.vdecoder.hifiganwithsnake.models import Generator
            self.dec = Generator(h=hps)
        else:
